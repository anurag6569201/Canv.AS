...
class category(models.Model):
    ...
    def category_image(self):
        return mark_safe('<img src="%s" width="50" height="50" alt="Category Image"/>'.format(self.image.url))
...
class vendor(models.Model):
    ...
    user=models.ForeignKey(User,on_delete=models.CASCADE.SET_NULL,null=True)
...
class Product(models.Model):
    ...
    price=models.DecimalField(max_digits=1000,decimal_places=2,default=100)
    old_price=models.DecimalField(max_digits=1000,decimal_places=2,default=200)
...
class CartOrder(models.Model):
    ...
    price=models.DecimalField(max_length=1000,decimal_places=2,default="100")
...
class CartOrderItems(models.Model):
    ...
    price=models.DecimalField(max_digits=1000,decimal_places=2,default=100)
    total=models.DecimalField(max_digits=1000,decimal_places=2,default=200)